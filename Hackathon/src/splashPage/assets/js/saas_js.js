"use strict"; + function(a, b) {
    ...
    c.defaults = {
        ...
        c.topbar(), c.parallax(), c.carousel(), c.scrolling(), c.counter(), c.aos(), c.typed(), c.contact(), c.mailer(), c.constellation(), c.shuffle(), objectFitPolyfill(a(".bg-video")), a(document).on("click", ".video-wrapper .btn", function() {
